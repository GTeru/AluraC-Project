...
namespace CasaDoCodigo.Controllers
{
    public class PedidoController : Controller
    {
        ...
        public async Task<IActionResult> BuscaDeProdutos(string TextoPesquisa = "")
        {
            var produtos = await produtoRepository.GetProdutos(TextoPesquisa);
            return View(new BuscaDeProdutos(produtos, TextoPesquisa));
        }
